...
# Introducing City to the testing arena!
City = city.City
...
class TestCity(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        """Ensuring values in the dict returned from to_dict are spot-on"""
        ...
        self.assertEqual(new_dict["created_at"], c.created_at.strftime(t_format))
        self.assertEqual(new_dict["updated_at"], c.updated_at.strftime(t_format))
    ...
    def test_state_id_attr(self):
        """Checking if City rocks the 'state_id' attribute, and it's an empty string"""
        city_instance = City()
    ...
    def test_name_attr(self):
        """Ensuring City has the 'name' attribute, and it's an empty string"""
        city_instance = City()
...
class TestCityDocs(unittest.TestCase):
    """Tests to make sure the documentation and style of City class are on point"""
    ...
    def test_city_func_docstrings(self):
        """Checking if City methods have the right amount of swag in their docstrings"""
    ...
    def test_city_module_docstring(self):
        """Making sure city.py module is not missing out on the docstring fun"""
        self.assertIsNot(city.__doc__, None,
