...
# Introducing Review to the testing stage!
...
class TestReview(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        """Ensuring values in the dict returned from to_dict are on point"""
        ...
        self.assertEqual(new_dict["created_at"], r.created_at.strftime(t_format))
        self.assertEqual(new_dict["updated_at"], r.updated_at.strftime(t_format))

    def test_to_dict_creates_dict(self):
        """Making sure to_dict method crafts a dictionary with the right vibes"""
        r = Review()
        new_dict = r.to_dict()
    ...
    def test_text_attr(self):
        """Checking if Review rocks the 'text' attribute, and it's an empty string"""
        review_instance = Review()
    ...
    def test_user_id_attr(self):
        """Ensuring Review has the 'user_id' attribute, and it's an empty string"""
        review_instance = Review()
    ...
    def test_place_id_attr(self):
        """Verifying Review has the 'place_id' attribute, and it's an empty string"""
        review_instance = Review()
...
class TestReviewDocs(unittest.TestCase):
    """Tests to make sure the documentation and style of Review class are on point"""
    ...
    def test_review_func_docstrings(self):
        """Checking if Review methods have the right amount of swag in their docstrings"""
        for func in self.review_functions:
            self.assertIsNot(func[1].__doc__, None,
                             "{:s} method needs a docstring, my friend!".format(func[0]))
    ...
    def test_review_module_docstring(self):
        """Making sure review.py module is not missing out on the docstring fun"""
        self.assertIsNot(review.__doc__, None,
