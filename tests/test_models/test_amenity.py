...
# Bringing Amenity into the spotlight!
...
class TestAmenity(unittest.TestCase):
    ...
    def test_str_amenity(self):
        """Checks if the str method does its thing properly"""
    ...
    def test_to_dict_values_amenity(self):
        """Makes sure the values in the dict returned from to_dict are on point"""
    ...
    def test_to_dict_creates_dict_amenity(self):
        """Checks if to_dict method crafts a dictionary with the right attributes"""
        am = Amenity()
        new_dict = am.to_dict()
    ...
    def test_name_attr_amenity(self):
        """Ensures Amenity has the 'name' attribute, and it's an empty string"""
        amenity_instance = Amenity()
    ...
    def test_is_subclass_amenity(self):
        """Confirms that Amenity is a cool subclass of BaseModel"""
        amenity_instance = Amenity()
...
class TestAmenityDocs(unittest.TestCase):
    """Tests to make sure the documentation and style of Amenity class are on point"""

    @classmethod
    def setUpClass_amenity(cls):
    ...
    def test_amenity_func_docstrings_amenity(self):
        """Checking if Amenity methods have the right amount of swag in their docstrings"""
    ...
    def test_amenity_module_docstring_amenity(self):
        """Making sure amenity.py module is not missing out on the docstring fun"""
        self.assertIsNot(amenity.__doc__, None,
