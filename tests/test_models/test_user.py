...
# Introducing the star of the show - User!
User = user.User
...
class TestUser(unittest.TestCase):
    ...
    def test_last_name_attr(self):
        """Checking if User rocks the 'last_name' attribute, and it's an empty string"""
        user_instance = User()
    ...
    def test_first_name_attr(self):
        """Checking if User rocks the 'first_name' attribute, and it's an empty string"""
        user_instance = User()
    ...
    def test_password_attr(self):
        """Checking if User rocks the 'password' attribute, and it's an empty string"""
        user_instance = User()
    ...
    def test_email_attr(self):
        """Checking if User rocks the 'email' attribute, and it's an empty string"""
        user_instance = User()
...
class TestUserDocs(unittest.TestCase):
    """Tests to make sure the documentation and style of User class are on point"""
    ...
    def test_user_func_docstrings(self):
        """Checking if User methods have the right amount of swag in their docstrings"""
    ...
    def test_user_module_docstring(self):
        """Making sure user.py module is not missing out on the docstring fun"""
        self.assertIsNot(user.__doc__, None,
