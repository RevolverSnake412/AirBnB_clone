...
# Rolling out the red carpet for Place!
Place = place.Place
...
class TestPlace(unittest.TestCase):
    ...
    def test_amenity_ids_attr(self):
        """Checking if Place rocks the 'amenity_ids' attribute, and it's an empty list"""
    ...
    def test_longitude_attr(self):
        """Ensuring Place has the 'longitude' attribute, and it's a float set to 0.0"""
        place_instance = Place()
    ...
    def test_latitude_attr(self):
        """Verifying Place has the 'latitude' attribute, and it's a float set to 0.0"""
        place_instance = Place()
...
class TestPlaceDocs(unittest.TestCase):
    """Tests to make sure the documentation and style of Place class are on point"""
    ...
    def test_place_func_docstrings(self):
        """Checking if Place methods have the right amount of swag in their docstrings"""
    ...
    def test_place_module_docstring(self):
        """Making sure place.py module is not missing out on the docstring fun"""
        self.assertIsNot(place.__doc__, None,
