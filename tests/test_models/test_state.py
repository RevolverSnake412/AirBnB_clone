...
# Welcoming State to the testing arena!
State = state.State
...
class TestState(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Checking if State rocks the 'name' attribute, and it's an empty string"""
        state_instance = State()
...
class TestStateDocs(unittest.TestCase):
    """Tests to make sure the documentation and style of State class are on point"""
    ...
    def test_state_func_docstrings(self):
        """Checking if State methods have the right amount of swag in their docstrings"""
    ...
    def test_state_module_docstring(self):
        """Making sure state.py module is not missing out on the docstring fun"""
        self.assertIsNot(state.__doc__, None,
